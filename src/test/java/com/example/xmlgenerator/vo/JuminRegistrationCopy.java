...
@XmlField(name = "IN-주민등록표등본신청서", type = XmlField.Type.Class, order = 0)
public class JuminRegistrationCopy implements ElecDocumentMetaData {
    @XmlField(name = "구분", type = XmlField.Type.Enum, order = 1)
    private static final CertificateType certificateType = CertificateType.JUMIN_REGISTRATION_COPY;
